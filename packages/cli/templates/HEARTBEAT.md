...
*   **Rollover:** Review `TODO.md`. Draft newly identified obligations from yesterday's synthesis as staged `[P2]` or `[P3]` tasks. Do not delete incomplete tasks.
*   **Report:** Generate a highly concise Daily Brief for the user containing: 1-2 actionable insights, proposed `TODO.md` additions, your proposed `HEARTBEAT.md` updates (from Dreaming), and a brief system status.
